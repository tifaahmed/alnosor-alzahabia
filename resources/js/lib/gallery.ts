...
export const serviceImages: Record<ServiceSlug, string> = {
    'general-maintenance': placeholder('general-maintenance'),
    'ac-maintenance': placeholder('ac-maintenance'),
    ...
    'water-filters': placeholder('water-filters'),
    painting: placeholder('painting'),
    plastering: placeholder('plastering'),
    'gypsum-board': placeholder('gypsum-board'),
    'ceramic-tiling': placeholder('ceramic-tiling'),
    'concrete-works': placeholder('concrete-works'),
    'screed-floors': placeholder('screed-floors'),
    'helicopter-floors': placeholder('helicopter-floors'),
    plumbing: placeholder('plumbing'),
    'bathroom-finishing': placeholder('bathroom-finishing'),
    electrical: placeholder('electrical'),
    carpentry: placeholder('carpentry'),
    ironwork: placeholder('ironwork'),
    'interlock-paving': placeholder('interlock-paving'),
    'swimming-pools': placeholder('swimming-pools'),
    'demolition-renovation': placeholder('demolition-renovation'),
    'apartment-shop-renovation': placeholder('apartment-shop-renovation'),
};
